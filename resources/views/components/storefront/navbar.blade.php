...
<header @class([
    ...
    <nav class="mx-auto grid h-16 max-w-screen-2xl grid-cols-[1fr_auto_1fr] items-center px-4 sm:h-20 sm:px-8 lg:px-12" aria-label="Navigasi toko">
        <div @class(['flex items-center justify-start', 'drop-shadow-lg' => $overlay]) data-navbar-left>
        ...
        <div @class(['flex items-center justify-end gap-0.5 sm:gap-1', 'drop-shadow-lg' => $overlay]) data-navbar-right>
