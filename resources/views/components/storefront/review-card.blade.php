...
@php
    $toneClass = match ($tone) {
        'sand' => 'from-[#F8FAFC] to-[#DDE6F0] text-[#0C1C39]',
        'sage' => 'from-[#EAF0F6] to-[#C7D0DC] text-[#0C1C39]',
        default => 'from-[#D9E4F0] to-[#EAF0F6] text-[#0C1C39]',
    };
@endphp
...
<article class="rounded-[1.75rem] border border-stone-200 bg-white p-5 sm:p-6" data-homepage-review-card>
    ...
    <h3 class="mt-4 font-display text-2xl leading-tight tracking-[-0.02em]">{{ $title }}</h3>
